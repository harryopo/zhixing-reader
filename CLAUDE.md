...
| `npm run test` | vitest 全通过（888 用例）| 手动 + CI |
...
- **门禁基线（2026-09-16 实测）**：typecheck 0 错误 ✅ / ESLint 0 错误（196 warning）✅ / Vitest **888 用例 · 41 文件**全通过 ✅ / electron-vite 三进程 build 成功 ✅ / 覆盖率 91.09-85.05-93.81-91.09 ✅
...
*最后更新：2026-09-16 | 数据血缘 + 启动修复 + 每日学习重做 + 交互审计 + 中文检索修复（888 用例 / 41 文件）*
