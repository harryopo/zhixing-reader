...
*最后更新：2026-09-23 | v1.3.4 已发布；之后 master 上补了 CI 换行符修复与 GitHub 维护面（issue 模板 / PR 模板 / SECURITY.md）、Electron 39 / Vitest 3 / electron-builder 26 三批依赖升级、密钥落盘加密接通 · 1050 用例 / 62 文件*
