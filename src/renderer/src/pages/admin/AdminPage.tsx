    ...
    <div className="h-full flex flex-col bg-gray-50">
      <div className="border-b border-gray-100 bg-white">
        <div className="max-w-6xl mx-auto px-5 py-3 flex items-center justify-between">
          ...
          <Link
            to="/"
            className="px-3 py-1.5 text-xs text-gray-500 hover:text-emerald-600 hover:bg-emerald-50 rounded-lg transition-colors font-medium"
          >
            返回应用
          </Link>
        </div>
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-6xl mx-auto px-5 py-5">
          <Suspense fallback={<div className="flex items-center justify-center h-64"><div className="animate-spin rounded-full h-6 w-6 border-b-2 border-emerald-600"></div></div>}>
