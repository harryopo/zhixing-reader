...
**组合标志的最小宽度：96px（下限 64px）。** 实测 420/160/96/64/40px 下整体着墨率
稳定在 18.8%→21.7%，且四个字各自着墨始终落在 3.1%–4.6% 区间、无一归零（说明笔画没有互相吞并）；
但 40px 时字标只有约 12px 高，中文密笔画读起来吃力，所以窄于此请只用徽标不用字标。
