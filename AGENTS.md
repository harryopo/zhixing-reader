...
> **最近核验**：2026-09-23（依赖批次：semver 范围内刷新锁文件，85 条 Dependabot 告警清掉 33 条、剩 52 条待跨大版本，electron 实测 35.7.5；同日更早：GitHub 维护一轮 —— CI 长期红的根因是检出换行符、补 issue/PR 模板与 SECURITY.md、README 数字按代码逐条重核、建 10 条 backlog issue；再早：v1.3.4 出包并发布）
