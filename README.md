...
[![Tests](https://img.shields.io/badge/tests-764%20%E7%94%A8%E4%BE%8B%20/%2033%20%E6%96%87%E4%BB%B6-22c55e)](./tests)
...
| **测试覆盖** | 764 用例 / 33 文件（覆盖率阈值 lines 83% / branches 80%，见 `vitest.config.ts`）|
...
| **测试** | Vitest | 2.x | 764 用例 / 33 文件，阈值见 `vitest.config.ts` |
...
├── tests/                                   # Vitest 单元测试（764 用例 / 33 文件）
├── resources/
