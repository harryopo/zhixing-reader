...
[![Tests](https://img.shields.io/badge/tests-733%20%E7%94%A8%E4%BE%8B%20/%2032%20%E6%96%87%E4%BB%B6-22c55e)](./tests)
...
| **测试覆盖** | 733 用例 / 32 文件（覆盖率阈值 lines 83% / branches 80%，见 `vitest.config.ts`）|
...
| **测试** | Vitest | 2.x | 733 用例 / 32 文件，阈值见 `vitest.config.ts` |
...
├── tests/                                   # Vitest 单元测试（733 用例 / 32 文件）
├── resources/
